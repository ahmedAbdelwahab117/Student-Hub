...
class StudentFamiliesScreen extends StatelessWidget {
  const StudentFamiliesScreen({super.key});
                              ...
                              children: [
                                ...
                                Padding(
                                  ...
                                  child: Row(
                                    children: [
                                      Text(
                                        "احداث خاصه بالفرق المسجله بالكليه",
                                        style: getMediumStyle(
                                            color: AppColors.black,
                                            fontSize: 15),
                                      ),
